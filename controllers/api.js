...
module.exports.generate_swagger_api_documentation = function(req,res,next){
    const swaggerAutogen = require('swagger-autogen')();
    const doc = {
        info: {
          title: 'Pillbro',
          description: 'An Online Doctor Consulation with medical products and services',
        },
        host: '128.199.28.150:5000',
        schemes: ['http'],
    };
...
module.exports.api_documentation = function(req,res,next){
